...
private extension OfferTableViewCell {
    ...
    func setupBrandLabel() {
        setupLabel(label: brandLabel, textColor: "#718897".hexaToUIColor(), font: UIFont(name: "SFProText-Regular", size: UI.FontSize.XXXS_MARGIN), numberOfLines: 1)
    ...
    func setupTitleLabel() {
        setupLabel(label: titleLabel, textColor: "#222D34".hexaToUIColor(), font: UIFont(name: "SFProText-Bold", size: UI.FontSize.S_MARGIN))
    ...
    func setupTagsLabel() {
        setupLabel(label: tagsLabel, textColor: "#718897".hexaToUIColor(), font: UIFont(name: "SFProText-Regular", size: UI.FontSize.XXXS_MARGIN), numberOfLines: 1)
    ...
    func setupFavoritesView() {
        ...
        setupLabel(label: favouritesLabel, textColor: "#718897".hexaToUIColor(), font: UIFont(name: "SFProText-Regular", size: UI.FontSize.XXXS_MARGIN), numberOfLines: 1)
